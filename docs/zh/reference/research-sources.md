...
- [Harbor framework documentation](https://www.harborframework.com/docs)：agent evaluation 的 task directory、`task.toml`、separate verifier artifacts、job/trial layout、ATIF trajectories、RewardKit、reward files 和 custom metrics。
