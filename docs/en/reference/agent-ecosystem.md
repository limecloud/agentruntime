...
## Where Agent Runtime fits

Agent Runtime owns execution facts and controls: sessions, threads, turns, tasks, runs, tools, permissions, model routing, snapshots, remote channels, and recovery.

Runtime accepts, executes, observes, controls, resumes, and audits agent work.
