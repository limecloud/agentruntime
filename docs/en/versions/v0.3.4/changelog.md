---
title: v0.3.4 changelog
description: Agent Runtime v0.3.4 changelog.
---
...
- Fixes the GitHub Pages logo path so repository-base deployments load the site logo correctly.
...
- Updated package version, release notes, LLM indexes, and version navigation to v0.3.4.
